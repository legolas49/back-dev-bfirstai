...
<svelte:head>
  ...
  <meta name="description" content="Interface d'administration BFirst AI - Environnement de développement" />
</svelte:head>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
      ...
      <div class="card">
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="status-indicator {status === 'ok' ? 'status-ok' : status === 'error' ? 'status-error' : 'status-loading'}"></div>
        </div>
      ...
      <div class="card">
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="status-indicator {dbStatus === 'ok' ? 'status-ok' : dbStatus === 'error' ? 'status-error' : 'status-loading'}"></div>
        </div>
        <p class="text-secondary">
          {#if dbStatus === 'ok'}
            ✅ MongoDB connectée
    ...
    <div class="card">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li><a href="https://github.com/legolas49/back-dev-bfirstai" target="_blank" class="text-primary hover:underline">📦 Repository GitHub</a></li>
            <li><a href="https://github.com/legolas49/back-dev-bfirstai/actions" target="_blank" class="text-primary hover:underline">🔄 GitHub Actions</a></li>
            <li><a href="https://github.com/legolas49/back-dev-bfirstai/packages" target="_blank" class="text-primary hover:underline">📦 GHCR Packages</a></li>
            <li><a href="/api/health" target="_blank" class="text-primary hover:underline">🏥 Health Check</a></li>
          </ul>
        </div>
      </div>
    </div>
